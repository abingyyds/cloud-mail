...
.send {
  ...
  animation: compose-backdrop 180ms ease-out both;
  ...
  .write-box {
    ...
    overflow: hidden;
    animation: compose-in 220ms cubic-bezier(0.22, 1, 0.36, 1) both;
